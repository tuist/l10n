...
The idea for l10n came from thinking and talking with [Maria Jose](https://github.com/mjsesalm), whose experience in localization was critical in making ideas click. She understood both the linguistic side and the tooling frustrations intimately.
...
Install the CLI with [mise](https://mise.jdx.dev):
